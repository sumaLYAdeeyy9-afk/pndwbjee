      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10">
          ...
          <p className="text-slate-300 text-xs sm:text-sm">
            Enter your details below to personalize and send an official representation to WBJEEB (<span className="text-white font-mono">TO</span>), DTE, Higher Education Dept & Hon'ble CM (<span className="text-white font-mono">CC</span>).
          </p>
        </div>
