...
import { Copy, Check, Sparkles, ExternalLink, RefreshCw, Shuffle } from 'lucide-react';
...
export default function TwitterStorm({ onActionCompleted }) {
  ...
  const activeTweetText = activeTemplate.text;
  ...
  const handlePostTweet = () => {
    const url = buildTweetIntentUrl(activeTweetText);
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10">
          ...
          <p className="text-slate-300 text-xs sm:text-sm">
            Targeting Hon'ble CM <span className="text-sky-400 font-bold">@SuvenduWB</span>, <span className="text-sky-400 font-bold">@CMO_WB</span>, <span className="text-sky-400 font-bold">@abpanandatv</span>, and <span className="text-sky-400 font-bold">@Zee24Ghanta</span> with 10 distinct variations to prevent spam-flagging.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          {/* Right Column: Live Tweet Preview (7 cols) */}
          <div className="lg:col-span-7 space-y-4 lg:sticky lg:top-20">
            ...
            <div className="bg-slate-950 rounded-2xl border border-slate-700 shadow-2xl p-5 sm:p-6">
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-2.5">
                  ...
                  <div>
                    ...
                    <span className="text-slate-400 text-[11px]">@WBJEE_Aspirants • Draft Preview</span>
                  </div>
                </div>
              ...
              {/* Tweet Body */}
              <div className="p-4 rounded-xl bg-slate-900 border border-slate-800 text-white text-xs sm:text-sm leading-relaxed mb-4 select-text">
                {activeTweetText}
              </div>
